    ...
    >
                ...
                {!showForm ? (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center gap-1.5 text-[10px] text-muted-foreground pt-1">
                      ...
                      <span>Your number is safe. No spam.</span>
                    </div>
                  </motion.div>
                ) : (
                  <motion.div
      ...
      <div className="relative group">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-14 h-14 rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white shadow-lg shadow-[#25D366]/30 flex items-center justify-center hover:shadow-xl hover:shadow-[#25D366]/40 transition-all"
