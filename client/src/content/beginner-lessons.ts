...
export const beginnerLessons: Record<string, LessonData> = {
    ...
    scenes: [
      ...
      },
      {
        ...
        content: [
          ...
          "Ownership ke saath growth ka benefit bhi aata hai aur risk bhi",
          "Teri liability limited hai – company doobe toh bhi tujhe karza nahi chukana",
        ],
      },
    ],
  },
  ...
  "sensex-nifty": {
    ...
    duration: "10 min",
    prevLesson: { slug: "share-kya-hai", title: "Share, Company aur Ownership ka simple matlab" },
    nextLesson: { slug: "ipo-kya-hai", title: "IPO kya hota hai?" },
    scenes: [
      {
        id: "m1l4-intro",
        type: "concept",
        title: "Aaj Ka Topic – Market Ka Score Samjho",
        content: [
          "Agar tumne kabhi news dekhi hai, toh zaroor suna hoga – 'Aaj Sensex 500 points gira' ya 'Nifty all-time high pe hai'.",
          "Par in words ka matlab kya hai? Kya ye koi magic number hai? Ya kuch important information de rahe hain?",
          "Aaj hum Sensex aur Nifty ko bilkul simple tarike se samjhenge. Ye sunne me technical lagte hain – par actually bahut aasan hain.",
        ],
      },
      {
        id: "m1l4-s1",
        ...
        speaker: "rohit",
        content: [
          "Didi, roz news me kehte hain 'Sensex gira', 'Nifty badha'. Ye dono kya hain? Aur inka girna-badhna humpe kaise affect karta hai?",
        ],
      },
      {
        id: "m1l4-s2",
        ...
        speaker: "priya",
        content: [
          "Bahut accha sawaal Rohit! Dekh, Sensex aur Nifty market ke 'health indicators' hain – bilkul jaise doctor thermometer se bukhar check karta hai.",
          "Ye batate hain ki overall market kaisa perform kar raha hai. Chalo ek simple example se samjhte hain.",
        ],
      },
      {
        id: "m1l4-s3",
        type: "example",
        title: "School Ka Result Card",
        content: [
          "Soch teri school me 5000 students hain. Principal ko jaanna hai ki overall school ka result kaisa raha.",
          "Kya wo 5000 students ka ek ek result dekhega? Nahi! Wo top 30 ya 50 students ka average dekh lega – isse idea mil jaata hai ki school overall kaisi perform kar rahi hai.",
          "Sensex aur Nifty bhi aise hi kaam karte hain. India me hazaaron companies listed hain – par in sabko track karna mushkil hai.",
          "Toh kuch select top companies ko mila ke ek 'average score' bana diya – jisse pata chale ki market overall kaisa chal raha hai.",
        ],
      },
      {
        id: "m1l4-s4",
        ...
        content: [
          "Sensex ka full form hai 'Sensitive Index'. Ye BSE (Bombay Stock Exchange) pe based hai.",
          "Isme India ki top 30 sabse badi aur important companies hain – jaise Reliance, TCS, HDFC Bank, Infosys.",
          "In 30 companies ka combined performance dekh ke ek number nikalta hai – wohi Sensex hai.",
          "Agar Sensex badha – matlab in 30 companies overall achha kar rahin hain. Agar gira – matlab thoda down hain.",
          "Aaj Sensex lagbhag 70,000-80,000 ke aas paas rehta hai. Ye number time ke saath badhta hai jaise economy grow karti hai.",
        ],
      },
      {
        id: "m1l4-s5",
        ...
        content: [
          "Nifty ka full form hai 'National Fifty'. Ye NSE (National Stock Exchange) pe based hai.",
          "Isme top 50 companies hain – matlab Sensex se thoda broader picture milta hai.",
          "Nifty zyada popular hai trading aur mutual funds me. Jab log 'market' ki baat karte hain, aksar Nifty hi refer karte hain.",
          "Aaj Nifty lagbhag 22,000-25,000 ke aas paas rehta hai.",
          "Dono – Sensex aur Nifty – mostly same direction me move karte hain, kyunki dono me mostly same badi companies hain.",
        ],
      },
      {
        id: "m1l4-s6",
        ...
        speaker: "rohit",
        content: [
          "Accha didi, toh agar Nifty 2% badha aaj – matlab mera portfolio bhi 2% badha?",
        ],
      },
      {
        id: "m1l4-s7",
        ...
        title: "Ek Common Confusion Clear Karo",
        content: [
          "Nahi Rohit! Ye ek common galat soch hai. Sensex aur Nifty sirf top 30-50 companies ka average hai – poori market nahi.",
          "Agar tune kisi chhoti company me invest kiya hai, toh uska performance Nifty se bilkul alag ho sakta hai.",
          "Nifty upar gaya – par teri company neeche bhi ja sakti hai. Ya Nifty gira – par teri company upar bhi ja sakti hai.",
          "Ye sirf ek overall indicator hai – tera personal portfolio alag behave kar sakta hai.",
          "Isliye apni investments ko individually track karo. Sirf Nifty dekh ke mat soch lo ki sab theek hai.",
        ],
      },
      {
        id: "m1l4-s8",
        type: "example",
        title: "Thermometer Wala Example",
        content: [
          "Soch aise – agar weather report kehti hai 'Delhi me average temperature 30 degree hai' – toh kya har jagah exactly 30 degree hoga?",
          "Nahi! Kisi jagah 28 hoga, kisi jagah 33. Average 30 hai – par individual readings alag hain.",
          "Sensex aur Nifty bhi market ka 'average temperature' batate hain – par har company ki apni individual story hoti hai.",
        ],
      },
      {
        id: "m1l4-s9",
        ...
        speaker: "rohit",
        content: [
          "Samajh gaya didi! Ye basically market ka quick health checkup hai – par full picture nahi.",
        ],
      },
      {
        id: "m1l4-s10",
        ...
        speaker: "priya",
        content: [
          "Exactly right! Ab jab bhi news me Sensex-Nifty ki baat suno – tum samjhoge ki ye kya indicate kar rahe hain.",
          "Par yaad rakho – ye sirf ek indicator hai. Smart investors apni companies ko individually study karte hain.",
        ],
      },
      {
        id: "m1l4-conclusion",
        ...
        title: "Aaj Ka Takeaway",
        content: [
          "Sensex aur Nifty market ke health indicators hain – jaise school ka average result ya weather ka average temperature.",
          "Sensex = BSE ki top 30 companies ka average. Nifty = NSE ki top 50 companies ka average.",
          "Ye overall market direction batate hain – par tera individual portfolio alag perform kar sakta hai.",
          "News samajhne ke liye ye helpful hai – par investment decisions sirf inhi pe mat lo.",
        ],
      },
      {
        id: "m1l4-summary",
        ...
        title: "Is Lesson Se Seekha",
        content: [
          "Sensex = BSE ki top 30 companies ka combined score",
          "Nifty 50 = NSE ki top 50 companies ka combined score",
          "Ye market ki overall direction batate hain – health indicator jaisa",
          "Par ye poori market nahi – tera portfolio alag behave kar sakta hai",
          "News samajhne ke liye useful – par investment decisions carefully lo",
        ],
      },
    ],
  },
  ...
  "ipo-kya-hai": {
    ...
    duration: "10 min",
    prevLesson: { slug: "sensex-nifty", title: "Sensex aur Nifty kya hote hain?" },
    nextLesson: { slug: "demat-account", title: "Demat account kya hota hai?" },
    scenes: [
      {
        id: "m1l5-intro",
        type: "concept",
        title: "Aaj Ka Topic – IPO Ka Simple Matlab",
        content: [
          "Aksar news me suna hoga – 'XYZ company ka IPO aa raha hai, bahut log apply kar rahe hain.' Par IPO exactly kya hota hai?",
          "IPO sunne me thoda technical lagta hai – par actually ye ek bahut simple concept hai. Aaj hum isko bilkul aasan bhasha me samjhenge.",
          "Koi jargon nahi, koi complicated process nahi. Bas seedhi baat.",
        ],
      },
      {
        id: "m1l5-s1",
        ...
        speaker: "rohit",
        content: [
          "Didi, mere dost keh rahe the ki unhe kisi company ka IPO mila. IPO matlab kya hota hai? Aur 'milna' ka kya matlab hai?",
        ],
      },
      {
        id: "m1l5-s2",
        ...
        speaker: "priya",
        content: [
          "Rohit, IPO ka full form hai 'Initial Public Offering'. Simple words me – jab ek company pehli baar apne shares public ko bechti hai, usse IPO kehte hain.",
          "Chalo ek daily life example se samjhte hain – tujhe bahut clearly samajh aa jayega.",
        ],
      },
      {
        id: "m1l5-s3",
        type: "example",
        title: "Ramu Ki Dukaan Ka Expansion",
        content: [
          "Yaad hai Ramu ki chai ki dukaan? Usne 50,000 rupaye lagake dukaan shuru ki thi. Uske 4 dost ne bhi paisa lagaya tha.",
          "Ab 5 saal baad Ramu ki dukaan bahut famous ho gayi. Wo ab 10 cities me 50 outlets kholna chahta hai.",
          "Par itna paisa kahan se aayega? Bank se loan lena mushkil hai. Dost aur family ke paas bhi limited paisa hai.",
          "Toh Ramu ne decide kiya – 'Main apni company ke shares aam public ko bechunga. Jo bhi kharidega, wo company ka hissedar ban jayega. Aur mujhe paisa mil jayega expand karne ke liye.'",
          "Ye pehli baar jab Ramu public ko shares bech raha hai – isi ko IPO kehte hain!",
        ],
      },
      {
        id: "m1l5-s4",
        ...
        speaker: "rohit",
        content: [
          "Accha! Toh IPO ke pehle company private hoti hai – sirf founders aur unke investors ke paas shares hote hain?",
        ],
      },
      {
        id: "m1l5-s5",
        ...
        speaker: "priya",
        content: [
          "Bilkul sahi! IPO se pehle company 'private' hoti hai – aam log uske shares nahi khareed sakte.",
          "IPO ke baad company 'public' ho jaati hai – matlab koi bhi stock market pe uske shares khareed-bech sakta hai.",
          "Isliye IPO ko 'going public' bhi kehte hain.",
        ],
      },
      {
        id: "m1l5-s6",
        type: "concept",
        title: "Company IPO Kyu Laati Hai?",
        content: [
          "1. Paisa Raise Karna: Sabse bada reason – company ko grow karne ke liye paisa chahiye. IPO se crores rupaye mil sakte hain.",
          "2. Brand Value: IPO ke baad company ka naam stock market pe list hota hai. Logo ko pata chalta hai ki ye ek badi company hai.",
          "3. Early Investors Ka Exit: Jo log shuru me invest kar chuke the (founders, angels), wo apna kuch hissa bech sakte hain.",
          "4. Employees Ko Reward: Bahut companies apne employees ko shares deti hain. IPO ke baad wo bech sakte hain.",
        ],
      },
      {
        id: "m1l5-s7",
        ...
        speaker: "rohit",
        content: [
          "Didi, ek doubt hai. Log kehte hain IPO me paisa lagao – bahut fayda hoga. Kya ye sach hai?",
        ],
      },
      {
        id: "m1l5-s8",
        ...
        title: "Ek Common Galat Soch Clear Karo",
        content: [
          "Rohit, ye bahut common confusion hai. Bahut log sochte hain ki har IPO me paisa lagane se fayda hoga – par ye sach nahi hai.",
          "Kuch IPOs listing ke din 50-100% bhi badh jaate hain. Par kuch IPOs listing ke din hi 20-30% gir bhi jaate hain.",
          "IPO me invest karna ek serious decision hai. Sirf 'hype' dekh ke mat karo. Company ki research karo, samjho ki wo kya karti hai.",
          "Aur yaad rakho – IPO me guaranteed profit ka koi promise nahi hota. Risk hamesha hai. Hum yahan tips nahi de rahe – sirf education.",
        ],
      },
      {
        id: "m1l5-s9",
        type: "example",
        title: "Mela Ka Stall Example",
        content: [
          "Soch aise – gaon me mela laga hai. Ek naya stall khula hai jo kuch unique bech raha hai. Bahut log line me hain.",
          "Kya sirf line dekh ke tu bhi khareedega? Ya pehle sochega ki actually cheez kya hai, kaam ki hai ya nahi?",
          "IPO bhi aise hi hai. Sirf hype ya line dekh ke mat karo. Samjho ki company kya karti hai, kaisi hai, phir decision lo.",
        ],
      },
      {
        id: "m1l5-s10",
        ...
        speaker: "rohit",
        content: [
          "Samajh gaya didi! IPO matlab company pehli baar public ko shares bech rahi hai. Par har IPO me fayda ho – ye zaruri nahi.",
        ],
      },
      {
        id: "m1l5-s11",
        ...
        speaker: "priya",
        content: [
          "Perfect summary! Ab tera IPO ka basic clear hai. Aage hum Demat account samjhenge – jiske bina tu shares khareed hi nahi sakta.",
          "Step by step seekhte raho. Jaldi mat karo, samajh ke aage badho.",
        ],
      },
      {
        id: "m1l5-conclusion",
        ...
        title: "Aaj Ka Takeaway",
        content: [
          "IPO = Initial Public Offering – jab company pehli baar public ko shares bechti hai.",
          "IPO se pehle company private hoti hai. IPO ke baad wo stock market pe list ho jaati hai – koi bhi khareed sakta hai.",
          "Company IPO laati hai paisa raise karne ke liye, brand build karne ke liye, aur early investors ko exit dene ke liye.",
          "Par har IPO profitable nahi hota. Research karo, samjho, phir decide karo. Hype me mat aao.",
        ],
      },
      {
        id: "m1l5-summary",
        ...
        content: [
          ...
          "IPO se pehle private, IPO ke baad public – koi bhi shares khareed sakta hai",
          "Companies IPO laati hain expansion, brand building, aur early investor exit ke liye",
          "Har IPO profitable nahi hota – research zaroori hai",
          "Sirf hype dekh ke invest mat karo – samajh ke decision lo",
        ],
      },
    ],
  },
