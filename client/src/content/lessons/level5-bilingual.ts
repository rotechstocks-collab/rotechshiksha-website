  ...
  hi: {
    ...
    scenes: [
      ...
      },
      {
        ...
        speaker: "narrator",
        content: [
          "SIP toh samajh gaye, lekin agar direct stocks me trade karna ho?",
          "Bina strategy ke trading gambling hai.",
          "",
          "Level 6 me jaano: Trading Strategies – Entry, Exit, Risk, Discipline",
        ],
      },
    ],
  },
  en: {
    ...
    scenes: [
      ...
      },
      {
        ...
        speaker: "narrator",
        content: [
          "SIP is clear, but what if you want to trade stocks directly?",
          "Trading without strategy is gambling.",
          "",
          "Find out in Level 6: Trading Strategies – Entry, Exit, Risk, Discipline",
        ],
      },
    ],
  },
